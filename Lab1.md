> You can try to execute these commands, except for the "Prepare database" steps, using the [Katacoda live environment](https://www.katacoda.com/mysql-db-sandbox) 
